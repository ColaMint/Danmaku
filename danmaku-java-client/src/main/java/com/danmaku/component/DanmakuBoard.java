...
import com.danmaku.engine.PaintProcess;
...
public class DanmakuBoard extends JDialog implements PaintProcess {
	...
	public DanmakuBoard(Engine engine) {
		this.engine = engine;
		 ...
		 */
		this.danmakuPanel.setBackground(new Color(1, 1, 1));

		this.danmakuSet = this.engine.getDanmakuSet();

		this.engine.addPaintProcess(this);
